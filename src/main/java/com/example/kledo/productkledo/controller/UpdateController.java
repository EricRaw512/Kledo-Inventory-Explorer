...
public class UpdateController {
    ...
    public String processUpdate(BearerRequest bearerRequest, Model model) {
        ...
        for (Warehouse warehouse : warehouses) {
            ...
            //Get The Product
            ProductsResponse fetchedProduct = apiService.fetchProductsFromApi(bearerToken, curWarehouseId);
            ...
            //Update The Product
            List<Product> products = updateProductPerWarehouse(fetchedProduct);
    ...
    private List<Product> updateProductPerWarehouse(ProductsResponse fetchedProduct) {
